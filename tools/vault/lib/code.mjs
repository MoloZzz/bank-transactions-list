 ...
 * `backend/src` (or `backend/.env.example`, `backend/package.json`) with
 ...
 * TypeORM `entities: [...]` array), we hard-fail instead of guessing.
 */
import * as path from 'node:path';
import { BACKEND_DIR, toPosix, readText, walk, sortBy } from './fs.mjs';
